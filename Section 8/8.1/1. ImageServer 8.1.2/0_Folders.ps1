...
$fileServerPath = "\\fileshare\Software\Enterprise\V10-8-1\AGSDeploy\Software\ArcGISImageServer"
...
"@
$folderStructureScriptPath = "F:\InstallScripts\Section 8\8.1\1. ImageServer 8.1.2\1_Folder_Creation.cmd"
...
echo %date% %time% >> F:\AGSDeploy\Logs\Permissions.log 
"@
$assignPrivilegesScriptPath = "F:\InstallScripts\Section 8\8.1\1. ImageServer 8.1.2\2_Folder_Privileges.cmd"
...
echo %date% %time% >> F:\AGSDeploy\Logs\Permissions.log 
"@
$assignLocalAdminsScriptPath = "F:\InstallScripts\Section 8\8.1\1. ImageServer 8.1.2\3_Group_Membership.cmd"
...
"@
$copyFilesScriptPath = "F:\InstallScripts\Section 8\8.1\1. ImageServer 8.1.2\4_Copy_Installation.cmd"
