...
icacls "F:\AGSDeploy" /grant "domain\GISPortal":(OI)(CI)F /Q /C /T
icacls "F:\AGSDeploy" /grant "domain\GISBackup":(OI)(CI)F /Q /C /T
...
icacls "F:\ArcGIS" /grant "domain\GISDataStore":(OI)(CI)F /Q /C /T
