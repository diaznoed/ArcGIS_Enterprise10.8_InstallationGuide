...
$portalAdminUserName = "domain\serviceaccountportal"
$backupUserName = "domain\serviceaccountbackup"
$serverUserName = "domain\serviceaccountserver"
$dataStoreUserName = "domain\serviceaccountdatastore"
$fileServerPath = "\\fileshare\Software\Enterprise\V10-8-1\AGSDeploy\Software\PortalForArcGIS"
