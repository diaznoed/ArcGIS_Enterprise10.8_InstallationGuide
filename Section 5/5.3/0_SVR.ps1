...
# Script paths
$establishPortsScript = "F:\InstallScripts\5.3\1_SVR_PortRules.cmd"
$installServerScript = "F:\InstallScripts\5.3\2_SVR_Install.cmd"
$licenseServerScript = "F:\InstallScripts\5.3\3_SVR_License.cmd"
$installPatchScript = "F:\InstallScripts\5.3\4_SVR_Patches.cmd"
$checkServerScript = "F:\InstallScripts\5.3\5_SVR_Check.cmd"
$installSQLClientScript = "F:\InstallScripts\5.3\6_SVR_SQL.cmd"
